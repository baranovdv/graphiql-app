...
const enStrings: Record<StringsTypes, string> = {
  ...
  no_docs: 'No Docs From that API',
  loading: 'Loading...',
  login_google: 'Enter with Google',
  no_acc_1: 'No account?',
  no_acc_2: 'Register',
  no_acc_3: 'here.',
  show_less: 'Show less',
